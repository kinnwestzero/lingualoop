...
Deno.serve(async(req)=>{
 ...
 const ai=await fetch("https://api.openai.com/v1/responses",{method:"POST",headers:{"Authorization":"Bearer "+openai,"Content-Type":"application/json"},body:JSON.stringify({model:"gpt-5.6-luna",input:[{role:"system",content:system+" Target language code: "+language+". Scene: "+String(body.context||"")},{role:"user",content:text}],reasoning:{effort:"none"},max_output_tokens:500})});
