...
Deno.serve(async(req)=>{
 ...
 const body=await req.json(), mode=body.mode==="correct"?"correct":"chat", language=body.lang||"en", text=String(body.text||"").slice(0,2000), history=Array.isArray(body.history)?body.history.slice(-8):[], roleplay=!!body.roleplay;
